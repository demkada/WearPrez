...
public class PrezActivity extends CordovaActivity {
    ...
    String activeTrainingSet = "Default_Gesture";
    ...
    IBinder gestureListenerStub = new IGestureRecognitionListener.Stub() {
        ...
        public void onGestureLearned(String gestureName) throws RemoteException {
            Toast.makeText(PrezActivity.this, String.format("Gesture %s learned", gestureName), Toast.LENGTH_SHORT).show();
            System.err.println("Gesture %s learned");
        }

        @Override
        public void onTrainingSetDeleted(String trainingSet) throws RemoteException {
            Toast.makeText(PrezActivity.this, String.format("Training set %s deleted", trainingSet), Toast.LENGTH_SHORT).show();
